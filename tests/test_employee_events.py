...
def test_employee_table_exists(table_names):
    ...
    assert 'employee' in table_names,f"'employee' table not found. Found:{table_names}"
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'team' in table_names,f"'team' table not found. Found:{table_names}"
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'employee_events' in table_names,f"'employee_events' table not found. Found:{table_names}"